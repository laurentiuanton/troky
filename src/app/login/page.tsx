            ...
            <>
              <div className="relative my-8">
                ...
                <div className="relative flex justify-center text-[10px] font-black uppercase tracking-[0.3em]">
                  <span className="bg-white/70 px-4 text-muted-foreground/60 backdrop-blur-xl">Sau continuă cu</span>
                </div>
              </div>
              ...
              <Button 
                ...
                className="w-full h-14 rounded-2xl border-2 border-border/40 hover:bg-white font-black text-xs uppercase tracking-widest gap-3 shadow-sm group transition-all"
              >
