        ...
        <CardContent className="p-8 pt-4 space-y-6">
          ...
          {!isForgot && (
            <>
              ...
              <div className="mt-6">
                <Button variant="outline" type="button" onClick={() => handleSocialLogin('google')} className="w-full h-12 rounded-xl font-bold border-border bg-white hover:bg-muted/50 transition-colors shadow-sm">
